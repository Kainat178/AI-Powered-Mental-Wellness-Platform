        ...
        <div style={S.card}>
          <div style={{ textAlign: "center", padding: "24px 0" }}>
            ...
            <p style={{ color: colors.textMuted, fontSize: 15, lineHeight: 1.6, marginBottom: 24, fontFamily: "'Nunito', sans-serif" }}>
              Welcome,{" "}
              <strong style={{ color: colors.rose }}>{form.fullName.split(" ")[0]}</strong>!
              <br />Your admin access has been granted.
            </p>
            <div style={{
              display: "inline-flex", alignItems: "center", gap: 8,
              background: colors.roseSoft, border: `1.5px solid ${colors.roseBorder}`,
              color: colors.rose, borderRadius: 50, padding: "10px 24px",
      ...
      <div style={S.card}>
        ...
        <div style={S.grid}>
          ...
          <div>
            ...
            <input type="email" placeholder="admin@calmmind.com"
          ...
          <div style={{ gridColumn: "1 / -1", textAlign: "center" }}>
            <p style={{ fontSize: 14, color: colors.textMuted, fontFamily: "'Nunito', sans-serif" }}>
              ...
              <a onClick={() => navigate("/login")}
                style={{ color: colors.rose, fontWeight: 700, cursor: "pointer" }}>
                Sign In
              </a>
            </p>
          </div>
...
const S = {
  ...
  blobA: {
    ...
    background: "radial-gradient(circle, #FBCFE844 0%, transparent 70%)",
    top: -120, left: -120,
  ...
  card: {
    ...
    boxShadow: "0 8px 60px rgba(190,24,93,0.10), 0 2px 16px rgba(124,58,237,0.06)",
  ...
  subtitle: {
    fontSize: 15, color: "#9896B8",
    fontWeight: 500, fontFamily: "'Nunito', sans-serif",
  },
  backBtn: {
    background: "none", color: "#9896B8",
    fontSize: 13, fontWeight: 700,
    padding: "0 0 14px", cursor: "pointer", display: "block",
  },
  roleTab: {
  ...
  eyeBtn: {
    ...
    cursor: "pointer", padding: 4, border: "none",
  },
  noticeBox: {
    display: "flex", alignItems: "center", gap: 12,
    background: "#FFF0F6", border: "1px solid #FBCFE8",
