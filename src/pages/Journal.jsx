...
const Journal = () => (
  <div className="page-enter" style={{ display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"60vh",gap:16,textAlign:"center" }}>
    ...
    <h2 style={{ fontFamily:fonts.display,fontSize:28,color:colors.text }}>Private Journal</h2>
    <p style={{ fontFamily:fonts.body,fontSize:15,color:colors.textMuted,maxWidth:360,lineHeight:1.6 }}>Your safe, encrypted space for thoughts, reflection and growth.</p>
