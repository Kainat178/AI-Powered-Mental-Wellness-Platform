  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.card}>
        ...
        {/* Back */}
        <button type="button" onClick={() => navigate("/login")} style={S.backBtn}>
          ← Back to Login
        </button>
        ...
        <div style={S.grid}>
          ...
          <div style={{ gridColumn: "1 / -1", textAlign: "center" }}>
            <p style={{ fontSize: 14, color: colors.textMuted, fontFamily: "'Nunito', sans-serif", marginBottom: 6 }}>
              Already have an account?{" "}
              <a onClick={() => navigate("/login")} style={{ color: colors.purple, fontWeight: 700, cursor: "pointer" }}>Sign In</a>
            </p>
            <p style={{ fontSize: 14, color: colors.textMuted, fontFamily: "'Nunito', sans-serif" }}>
              Are you a therapist?{" "}
              <a onClick={() => navigate("/therapist-signup")} style={{ color: colors.purple, fontWeight: 700, cursor: "pointer" }}>Apply here</a>
            </p>
          </div>
...
const S = {
  page: {
    minHeight: "100vh", background: "#F0EEFB",
    display: "flex", flexDirection: "column", alignItems: "center",
    padding: "32px 16px 48px", fontFamily: "'Nunito', sans-serif",
    position: "relative", overflow: "hidden",
  },
  blobA: {
    position: "fixed", width: 420, height: 420,
    background: "radial-gradient(circle, #C4B5FD44 0%, transparent 70%)",
    top: -120, left: -120, animation: "blob 9s ease-in-out infinite",
    pointerEvents: "none", zIndex: 0,
  },
  blobB: {
    position: "fixed", width: 320, height: 320,
    background: "radial-gradient(circle, #DDD6FE33 0%, transparent 70%)",
    bottom: -80, right: -80, animation: "blob 11s ease-in-out infinite reverse",
    pointerEvents: "none", zIndex: 0,
  },
  logoWrap: {
    display: "flex", alignItems: "center", gap: 8,
    marginBottom: 24, cursor: "pointer", zIndex: 1,
  ...
  card: {
    background: "#FAF7F0", borderRadius: 28, padding: "40px 48px",
    width: "100%", maxWidth: 680,
    boxShadow: "0 8px 60px rgba(124,58,237,0.12)",
    position: "relative", zIndex: 1, animation: "fadeUp 0.5s ease both",
  },
  heading: {
    fontFamily: "'Playfair Display', serif",
    fontSize: 28, fontWeight: 800, color: "#1E1B4B", letterSpacing: "-0.5px",
  },
  subtitle: {
    fontSize: 15, color: "#9896B8", fontWeight: 500,
    fontFamily: "'Nunito', sans-serif",
  },
  backBtn: {
    background: "none", color: "#9896B8", fontSize: 13,
    fontWeight: 700, padding: "0 0 14px", cursor: "pointer", display: "block",
  },
  roleTab: {
  ...
  eyeBtn: {
    ...
    fontSize: 16, cursor: "pointer", padding: 4, border: "none",
  },
  submitBtn: {
    width: "100%", padding: "16px", borderRadius: 50,
    color: "#fff", fontSize: 16, fontWeight: 800, letterSpacing: "0.3px",
    boxShadow: "0 6px 24px rgba(124,58,237,0.35)", transition: "all 0.2s ease",
  },
  spinner: {
    width: 16, height: 16,
