        ...
        <div style={styles.card}>
          <div style={{ textAlign: "center", padding: "24px 0" }}>
            ...
            <p style={{ color: colors.textMuted, fontSize: 15, lineHeight: 1.6, marginBottom: 12, fontFamily: "'Nunito', sans-serif" }}>
              Thank you,{" "}
              <strong style={{ color: colors.teal }}>{form.fullName}</strong>!
              <br />
              Your license will be verified within <strong>24–48 hours</strong> before activation.
            </p>
            <div style={{
              display: "inline-flex", alignItems: "center", gap: 8,
              background: colors.tealSoft, border: `1.5px solid ${colors.tealBorder}`,
              color: colors.teal, borderRadius: 50, padding: "10px 24px",
      ...
      <div style={styles.card}>
        ...
        <div style={styles.grid}>
          ...
          <div>
            ...
            <input
              type="email"
              placeholder="dr.anya@clinic.com"
              value={form.email}
          ...
          {/* Row 3: Specialization + Years of Experience */}
          <div>
...
const styles = {
  ...
  card: {
    ...
    width: "100%",
    maxWidth: 680,
    boxShadow: "0 8px 60px rgba(14,116,144,0.10), 0 2px 16px rgba(124,58,237,0.06)",
    position: "relative",
    zIndex: 1,
